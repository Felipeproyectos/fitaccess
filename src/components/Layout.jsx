  ...
  return (
        <div className="lg:hidden flex items-center gap-3 px-4 py-3 border-b border-border bg-card"
          ...
          {isRoot ? (
              ...
              <span className="font-display text-lg text-gradient tracking-wider">FITACCESS</span>span>
          {!isRoot && (
          ...
          <>
                <div className="p-6 border-b border-border">
                        <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                              <h1 className="font-display text-xl text-gradient tracking-wider">FITACCESS</h1>h1>
                                              <p className="text-xs text-muted-foreground">Control de acceso</p>p>
                                  </div>div>
                        </div>div>
                </div>div>
                ...
                <div className="p-4 border-t border-border space-y-1">
                        ...
                        <div className="flex flex-col items-center gap-1 px-3 py-3">
                                  ...
                                  <div className="text-center">
                                              <p className="text-[10px] text-muted-foreground leading-tight">Sistema creado por</p>p>
                                              <p className="text-xs font-bold text-white leading-tight">BYTE SUR</p>p>
                                              <p className="text-[10px] text-muted-foreground leading-tight">Soluciones Tecnológicas</p>p>
                                  </div>div>
                        </div>div>
                </div>div>
          </>>
