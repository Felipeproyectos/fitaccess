    ...
    <>
      ...
      <div className="p-4 border-t border-border space-y-1">
        ...
        <div className="flex items-center gap-3 px-3 py-2.5">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#FF3B3B] to-[#FF7A00] flex items-center justify-center glow-red shrink-0">
            <Dumbbell className="w-5 h-5 text-white" />
          </div>
          <div>
            <h1 className="font-display text-base text-gradient tracking-wider">FITACCESS</h1>
            <p className="text-[10px] text-muted-foreground leading-tight">Sistema creado por Soluciones FML</p>
          </div>
        </div>
      </div>
    </>
